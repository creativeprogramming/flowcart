 ...
 *
 */
class FlowcartModelCountry extends JModelAdmin
{
	/**
	...
	{
		// Get the form.
		$form = $this->loadForm('com_flowcart.country', 'country', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_flowcart.edit.country.data', array());
