...
$action = JRoute::_('index.php?option=com_flowcart&view=countries');
		...
		<table id="adminTable" class="adminlist" width="100%" cellpadding="2" cellspacing="2">
			<thead>
				<tr>
					...
					<th class="name">
						<?php echo JHtml::_('grid.sort',  'COM_FLOWCART_NAME_LABEL', 'c.name', $listDirn, $listOrder); ?>
					</th>
					<th width="5%">
						<?php echo JHtml::_('grid.sort',  'JPUBLISHED', 'c.active', $listDirn, $listOrder); ?>
					</th>
					<th class="id">
						<?php echo JHtml::_('grid.sort',  'COM_FLOWCART_FIELD_ID_LABEL', 'c.id', $listDirn, $listOrder); ?>
					</th>
				</tr>
			</thead>
			<tfoot>
				...
				<tbody>
					<?php foreach ($this->items as $i => $item): ?>
						...
						<tr class="row&lt;?php echo $i%2; ?&gt;">
							...
							<td>
								<a href="<?php echo JRoute::_('index.php?option=com_flowcart&task=country.edit&id='.$item->id);?>">
									<?php echo $this->escape($item->name); ?>
								</a>
							</td>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->active, $i, 'countries.', $canChange, 'cb'); ?>
							</td>
							<td>
								<?php echo $item->id; ?>
							</td>
