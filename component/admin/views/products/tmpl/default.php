...
$action = JRoute::_('index.php?option=com_flowcart&view=products');
		...
		<table id="adminTable" class="adminlist" width="100%" cellpadding="2" cellspacing="2">
			<thead>
				<tr>
					...
					<th class="name">
						<?php echo JHtml::_('grid.sort',  'COM_FLOWCART_NAME_LABEL', 'p.name', $listDirn, $listOrder); ?>
					</th>
					<th width="5%">
						<?php echo JHtml::_('grid.sort',  'JPUBLISHED', 'p.active', $listDirn, $listOrder); ?>
					</th>
					<th class="id">
						<?php echo JHtml::_('grid.sort',  'COM_FLOWCART_ZONE_ID', 'p.id', $listDirn, $listOrder); ?>
					</th>
				</tr>
			</thead>
			<tfoot>
				...
				<tbody>
					<?php foreach ($this->items as $i => $item): ?>
						...
						<tr class="row&lt;?php echo $i%2; ?&gt;">
							...
							<td>
								<a href="<?php echo JRoute::_('index.php?option=com_flowcart&task=product.edit&id='.$item->id);?>">
									<?php echo $this->escape($item->name); ?>
								</a>
							</td>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->active, $i, 'products.', $canChange, 'cb'); ?>
							</td>
							<td>
								<?php echo $item->id; ?>
							</td>
